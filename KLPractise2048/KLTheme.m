...
@interface KLDefaultTheme : NSObject <KLTheme>
@end

@implementation KLDefaultTheme
...
@interface KLVibrantTheme : NSObject <KLTheme>

@end

@implementation KLVibrantTheme
...
@interface KLJoyfulTheme : NSObject <KLTheme>

@end

@implementation KLJoyfulTheme
...
+ (Class)themeClassForType:(NSInteger)type {
    switch (type) {
        case 1:
            return [KLDefaultTheme class];
        case 2:
            return [KLVibrantTheme class];
            
        default:
            return [KLJoyfulTheme class];
    }
}
